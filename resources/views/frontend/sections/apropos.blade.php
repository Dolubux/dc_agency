                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6" data-aos="fade-left">
                        <div class="position-relative">
                            <img src="{{$entreprise?->getFirstMediaUrl('image_apropos')}}?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" alt="Équipe DC Agency" class="img-fluid rounded shadow-lg">
