...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form id="formSend" action="{{ route('entreprise.update', $entreprise->id) }}" method="POST"
                            ...
                            <div class="col-md-7">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="libelle_apropos" id="libelle_apropos" class="form-control"
                                        required value="{{ old('libelle_apropos', $entreprise->libelle_apropos) }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description_apropos" id="ckeditor-classic">{{ old('description_apropos', $entreprise->description_apropos) }}</textarea>
                                ...
                                <div class="card">
                                    <div class="mb-3">
                                        ...
                                        <div class="mt-2 position-relative" style="display: inline-block;">
                                            @php
                                                $banniereUrl = $entreprise->getFirstMediaUrl('banniere');
                                            @endphp
                                            <img id="previewImage" src="{{ $banniereUrl ? $banniereUrl : '#' }}"
                                                alt="Aperçu"
                                                style="max-width: 200px; {{ $banniereUrl ? '' : 'display:none;' }}" />
                                            <button type="button" id="removeImageBtn" class="btn btn-danger btn-sm"
                                                style="position: absolute; top: 5px; right: 5px; {{ $banniereUrl ? '' : 'display:none;' }}">
                                    ...
                                    <div class="mb-3">
                                        <label for="formFile2" class="form-label">Image a propos</label>
                                        <input class="form-control" type="file" id="formFile2" name="image_apropos"
                                            accept="image/*">
                                        <div class="mt-2 position-relative" style="display: inline-block;">
                                            @php
                                                $aproposUrl = $entreprise->getFirstMediaUrl('image_apropos');
                                            @endphp
                                            <img id="previewImage2" src="{{ $aproposUrl ? $aproposUrl : '#' }}"
                                                alt="Aperçu"
                                                style="max-width: 200px; {{ $aproposUrl ? '' : 'display:none;' }}" />
                                            <button type="button" id="removeImageBtn2" class="btn btn-danger btn-sm"
                                                style="position: absolute; top: 5px; right: 5px; {{ $aproposUrl ? '' : 'display:none;' }}">
                                                <i class="ri-delete-bin-line"></i>
                                            </button>
                                        </div>
                                    </div>
    ...
    @section('script')
        ...
        <script>
            // Aperçu et suppression de l'image banniere
