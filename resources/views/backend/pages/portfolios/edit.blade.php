                            ...
                            <div class="col-md-7">
                                ...
                                <div class="mb-3">
                                    <label for="description" class="form-label">Description <span
                                            class="text-danger">*</span></label>
                                    <textarea name="description" id="ckeditor-classic" class="form-control" required>{{ old('description', $portfolio->description) }}</textarea>
                                    @error('description')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
...
@section('script')
 <script src="{{ URL::asset('build/libs/prismjs/prism.js') }}"></script>
    ...
    <script>
        ...
        // Aperçu des nouvelles images galerie + suppression + taille max 1Mo + pas de doublon
        let galleryFiles = [];
        ...
        function updateGalleryPreview() {
            // Affiche uniquement les nouvelles images à uploader
